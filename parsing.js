                        ...
                        if(modelname==undefined){
                            ...
                            SK_ACE.update(
                                {model:modelname},
                                {
                                    ...
                                    ofc_mnp_36 : obj[1].data[i][13]*10000,
                                    ofc_chn_36 : obj[1].data[i][14]*10000,
                                    ofc_new_el : obj[1].data[i][15]*10000,
                                    ofc_mnp_el : obj[1].data[i][16]*10000,
                                    ofc_chn_el : obj[1].data[i][17]*10000,
                                    cho_new_59 : obj[1].data[i][18]*10000,
                                    cho_mnp_59 : obj[1].data[i][19]*10000,
                                    cho_chn_59 : obj[1].data[i][20]*10000,
                                    cho_new_51 : obj[1].data[i][21]*10000,
                                    cho_mnp_51 : obj[1].data[i][22]*10000, 
                                    cho_chn_51 : obj[1].data[i][23]*10000,
                                    cho_new_36 : obj[1].data[i][24]*10000,
                                    cho_mnp_36 : obj[1].data[i][25]*10000,
                                    cho_chn_36 : obj[1].data[i][26]*10000,
                                    cho_new_el : obj[1].data[i][27]*10000,
                                    cho_mnp_el : obj[1].data[i][28]*10000, 
                                    cho_chn_el : obj[1].data[i][29]*10000,
                                },
                                {upsert:true},
                                function(err){
                                    if(err){
